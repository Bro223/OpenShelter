...
export const ET: Messages = {
  ...
  'admin.guidance.editor.bodyHint':
    'Salvestamisel säilivad ainult tööriistapaneeli tähised — H1 ega sisetekstipilte ei ole tahtlikult (leht ise omab pealkirja ja pealtpildi). Asetatud tekst sisestatakse tavalisena.',
  'admin.guidance.editor.bodyRequired': 'Sisukeha on kohustuslik.',
  'admin.guidance.editor.toolbar': 'Tekstivormindamine',
  'admin.guidance.editor.blockLabel': 'Lõigatiüp',
  'admin.guidance.editor.inlineLabel': 'Teksti stiil',
  'admin.guidance.editor.block.p': 'Lõige',
  'admin.guidance.editor.block.h2': 'Pealkiri 2',
  'admin.guidance.editor.block.h3': 'Pealkiri 3',
  'admin.guidance.editor.block.ul': 'Punktiga loetelu',
  'admin.guidance.editor.block.ol': 'Numberdatud loetelu',
  'admin.guidance.editor.bold': 'Rasvane',
  'admin.guidance.editor.italic': 'Kaldkiri',
  'admin.guidance.editor.link': 'Viide',
