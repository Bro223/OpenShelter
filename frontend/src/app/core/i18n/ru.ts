...
export const RU: Messages = {
  ...
  'a11y.popup.body':
    'Выберите, как OpenShelter будет выглядеть для вас. Выбор применяется сразу.',
  ...
  'submit.verifyHint': 'Этот аккаунт больше не может добавлять укрытия: его подтверждение недействительно.',
  ...
  'account.delete.armed': 'Кнопка «Удалить мой аккаунт» теперь доступна. Её нажатие навсегда удаляет ваш аккаунт.',
  ...
  'legal.privacy.why.p2':
    'Правовое основание для каждой цели — [LEGAL BASIS TO BE CONFIRMED].',
