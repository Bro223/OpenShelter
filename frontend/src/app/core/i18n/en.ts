...
export const EN: Messages = {
  ...
  'admin.guidance.editor.bodyHint':
    'Only the toolbar formatting survives saving — no H1 and no inline images, deliberately (the page owns the heading and the hero image). Pasted text is inserted as plain text.',
  'admin.guidance.editor.bodyRequired': 'A body is required.',
  'admin.guidance.editor.toolbar': 'Text formatting',
  'admin.guidance.editor.blockLabel': 'Paragraph style',
  'admin.guidance.editor.inlineLabel': 'Text style',
  'admin.guidance.editor.block.p': 'Paragraph',
  'admin.guidance.editor.block.h2': 'Heading 2',
  'admin.guidance.editor.block.h3': 'Heading 3',
  'admin.guidance.editor.block.ul': 'Bulleted list',
  'admin.guidance.editor.block.ol': 'Numbered list',
  'admin.guidance.editor.bold': 'Bold',
  'admin.guidance.editor.italic': 'Italic',
  'admin.guidance.editor.link': 'Link',
