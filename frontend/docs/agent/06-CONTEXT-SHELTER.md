...
- **Trust reports** (verified users; the report answers the dampening outcome, the occupancy
  ...
  OTHER "Something else" + optional detail for OTHER; closed/open is the separate two-state
