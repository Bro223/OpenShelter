...
(registry + user-submitted), a sidebar list, and the legend — whose entries double as the
pin-tone filter (the source chips are gone, wave 8: the page fetches `ALL` sources). No login
required. Detail
...
| ---------------- | ---------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ShelterGateway` | service (`gateways/`)                                                                                      | `list(source: ShelterSourceFilter, trust?: ShelterTrustFilter): ShelterDto[]` → `GET /api/shelters?source=…` (`ALL` \| `REGISTRY` \| `USER`, server-side; the map page calls it with `ALL` — the three source chips are gone, wave 8 — and does NOT wire the backend's `?provenance=` taxonomy filter) + the optional `hasCapacity` trust filter — absent fields are omitted from the query string entirely; `get(id)` → `GET /api/shelters/{id}` → `ShelterDetailDto` (the list DTO + `yourOccupancyBand`; used by M5 too). Every row also carries `reportCount` + `lastVerifiedAt` (**M8, entry-verification-meta**: the total community-report count and the server-derived verification stamp — registry rows: newest OK/NOT_MODIFIED import of their source; community rows: newest non-submitter OPEN_CONFIRMED check or confirming moderation action; null = never verified).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
5. **The trust palette is visible (M6 / community-review-queue D5).** A small legend explains
   the marker palette: blue = registry (Päästeamet + municipal rows), the community
   verification family — the YELLOW triangle when the API reports no confirmed channel
   (`--color-shelter-user`), the yellow circle at exactly one confirmed channel, the verified
   GREEN circle (`--color-verified`) at two or more — shape AND hue carry the depth, never
   colour alone (NEW is not a marker tone, the "Newly added" badge says NEW,
   never the pin),
   ...
   entries (registry / unverified triangle / partially-verified yellow circle / fully-verified
   green circle /
