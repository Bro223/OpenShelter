...
5. **Provenance is visible (M6).** A small legend explains the marker palette: blue = official
   ...
   community-checked, amber = newly added (unconfirmed community), orange = reported
