...
- **moderate (admin only)**: the env-provisioned admin (admin-moderation) sees an admin-only
  "Admin" nav item and the `/admin` page — eight tabs working the trust layer: the unconfirmed
