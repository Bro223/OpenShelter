...
- **Crisis guidance + shelter-list viewport/paging (crisis-guidance, shelter-bbox-paging)** —
  ...
  Current repo-wide counts: **806 backend tests / 1026 frontend tests** (counted 2026-09-16
  on this tree; the per-wave numbers further down are historical).
...
- **Trust & reports (shelter-trust-and-reports)** — community trust layer: shelter
  ...
  **657 frontend tests across 35 spec files** (both counted 2026-09-11 — historical; the
  tree now runs 806 backend / 1026 frontend, counted 2026-09-16 above), all green.
...
| GET    | `/api/guidance`                                                                           | public                  | Crisis-guidance index — **published posts only**, pinned posts first and then the admin's manual order (`V28` `sort_order`; equal stamps: newest published → oldest; equal ids impossible) → `GuidancePostDto[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| GET    | `/admin/guidance`                                                                         | JWT + ADMIN kind        | **Every post incl. drafts** (pinned first, then the manual order) → `AdminGuidancePostDto[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
- Persistence (Flyway `V1`–`V28` + the Java `V13`, JPA, `ddl-auto=validate`), uniform error handling
